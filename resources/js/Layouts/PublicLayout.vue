        ...
        <div class="fixed right-0 top-1/2 transform -translate-y-1/2 z-50 flex shadow-lg rounded-l-lg bg-white border border-r-0 border-gray-200" 
            ...
            <div class="overflow-hidden transition-all duration-300 ease-in-out bg-white"
                ...
                <div class="flex flex-col space-y-5 py-4 items-center w-14 border-l border-gray-100 h-full justify-center">
                    <!-- Facebook -->
                    <a href="#" target="_blank" class="text-blue-600 hover:scale-110 transition-transform" title="Facebook">
                    ...
                    <!-- Twitter / X -->
                    <a href="#" target="_blank" class="text-gray-900 border border-gray-900 rounded-full p-[2px] hover:bg-gray-100 hover:scale-110 transition-transform" title="X (Twitter)">
                        <svg class="w-5 h-5 mx-auto" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
