            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.pages.update', $page) }}" method="POST"
                        x-data="{ title: '{{ $page->title }}', slug: '{{ $page->slug }}' }">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            <label class="inline-flex items-center">
                                ...
                                <input type="checkbox" name="is_published" value="1"
                                    class="form-checkbox h-5 w-5 text-blue-600" {{ $page->is_published ? 'checked' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="seo_description"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ $page->seo_description }}</textarea>
                        </div>
